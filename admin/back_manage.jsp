...
//Step 3: 選擇資料庫   
            ...
            {   
                ...
                String vip = "SELECT * FROM `vip` WHERE `vip_account` ='"+rs.getString(2)+"'";
                ResultSet rs3 = con.createStatement().executeQuery(vip);
                while (rs3.next())
                {   
...
//Step 3: 選擇資料庫   
            ...
            {   
                ...
                String vip = "SELECT * FROM `vip` WHERE `vip_account` ='"+rs.getString(3)+"'";
                ResultSet rs3 = con.createStatement().executeQuery(vip);
                while (rs3.next())
                {   
                    out.print("<div>會員姓名："+rs3.getString(2)+"</div><br>");
