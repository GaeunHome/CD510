...
<body>
    ...
    <div style="width:100%">
        ...
        <div class="list" style="width:100%;text-align:center">
            ...
            <div>產品價格：<input type="text" class="text_input" value = "<%=rs1.getInt(7)%>" name="price"></div><br>
            <div>唱片歌手：<input type="text" class="text_input" value = "<%=rs1.getString(4)%>" name="singer"></div><br>
            <div>歌手圖片：<input type="text" class="text_input" value = "<%=rs1.getString(5)%>" name="singer_img"></div><br>
            <div>歌手簡介：<input type="text" class="text_input" value = "<%=rs1.getString(6)%>" name="singer_intro"></div><br>
            <div>產品介紹：<input type="text" class="text_input" value = "<%=rs1.getString(9)%>" name="introduction"></div><br>
            <div>產品庫存：<input type="text" class="text_input" value = "<%=rs1.getInt(8)%>" name="amount"></div><br>
            <div>圖片路徑：<input type="text" class="text_input" value = "<%=rs1.getString(2)%>" name="img"></div><br>
            <div>類別：<input type="text" class="text_input" name="kind" value = "<%=rs1.getString(10)%>"></div><br>
            <div>唱片公司：<input type="text" class="text_input" name="company" value = "<%=rs1.getString(11)%>"></div><br>
            <div>發片時間：<input type="text" class="text_input" name="pubtime" value = "<%=rs1.getString(12)%>"></div><br>
